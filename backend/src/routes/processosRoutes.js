...
router.get('/:id/financeiro-lancamentos', requirePapel('administrador'), financeiroController.listarPorProcesso);
router.post('/:id/financeiro-lancamentos', requirePapel('administrador'), financeiroController.criar);
